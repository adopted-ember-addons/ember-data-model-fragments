...
module('unit - `DS.Store`', function (hooks) {
  ...
  test('a fragment can be created that starts in a dirty state', function (this: TestContext, assert: Assert) {
  ...
  test('createFragment applies provided values even when defaults exist', function (this: TestContext, assert: Assert) {
  ...
  test('attempting to create a fragment type that does not inherit from `MF.Fragment` throws an error', function (this: TestContext, assert: Assert) {
    assert.expectAssertion(() => {
      store.createFragment('person');
    }, "The 'person' model must be a subclass of MF.Fragment");
  });

  test('the store has an `isFragment` method', function (this: TestContext, assert: Assert) {
  ...
  test('fragments do NOT fall back to the application serializer', function (this: TestContext, assert: Assert) {
  ...
  test('a per-fragment serializer registration wins over the default fallback', function (this: TestContext, assert: Assert) {
  ...
  test('a serializer:-fragment registration overrides the default fragment fallback for all fragments', function (this: TestContext, assert: Assert) {
  ...
  test('the application serializer can be looked up', function (this: TestContext, assert: Assert) {
    assert.ok(
  ...
  test('the default serializer can be looked up', function (this: TestContext, assert: Assert) {
    assert.ok(
  ...
  test('pushPayload deserializes fragments end-to-end with the default REST application serializer', function (this: TestContext, assert: Assert) {
  ...
  test('unloadAll destroys fragments', function (this: TestContext, assert: Assert) {
