...
module(
  ...
  function (hooks) {
    ...
    test('serializerFor on the instance is installed by FragmentStore, not inherited', function (this: TestContext, assert: Assert) {
    ...
    test('non-fragment lookups defer to the parent serializerFor', function (this: TestContext, assert: Assert) {
    ...
    test('serializerFor does not throw for unknown model names', function (this: TestContext, assert: Assert) {
    ...
    test('synthetic names never enter the fragment branch', function (this: TestContext, assert: Assert) {
    ...
    test('repeated fragment lookups return a working FragmentSerializer', function (this: TestContext, assert: Assert) {
    ...
    test('serializer:-mf-fragment is registered exactly once and reused', function (this: TestContext, assert: Assert) {
