...
import type { FragmentAttributeMeta } from '#src/-private/types.ts';
...
module('unit - FragmentCache', function (hooks) {
  ...
  module('upsert - separates fragment attributes', function () {
    test('fragment attributes are handled separately from regular attributes', function (this: TestContext, assert: Assert) {
      store.push({
        data: {
          type: 'person',
          id: '1',
    ...
    test('pushing new data updates fragment attributes', function (this: TestContext, assert: Assert) {
      store.push({
        data: {
          type: 'person',
          id: '1',
  ...
  module('getAttr - returns Fragment instances', function () {
    test('getAttr returns Fragment instance for fragment attributes', function (this: TestContext, assert: Assert) {
      store.push({
        data: {
          type: 'person',
          id: '1',
    ...
    test('getAttr returns array of Fragment instances for fragmentArray attributes', function (this: TestContext, assert: Assert) {
      store.push({
        data: {
          type: 'person',
          id: '1',
    ...
    test('getAttr returns null for null fragment attributes', function (this: TestContext, assert: Assert) {
      store.push({
        data: {
          type: 'person',
          id: '1',
    ...
    test('schema surfaces include fragment fields consistently', function (this: TestContext, assert: Assert) {
      store.push({
        data: {
          type: 'person',
          id: '1',
      ...
      // ember-data's `LegacyAttributeField` has no notion of the addon's
      // fragment metadata, so read the definitions through the addon's type.
      const definitions = schema.attributesDefinitionFor!(
        identifier,
      ) as unknown as Record<string, FragmentAttributeMeta>;
  ...
  module('setAttr - dirty state propagation', function () {
    test('setting fragment attribute propagates dirty state to owner', function (this: TestContext, assert: Assert) {
      store.push({
        data: {
          type: 'person',
          id: '1',
    ...
    test('resetting fragment attribute to original value clears dirty state', function (this: TestContext, assert: Assert) {
      store.push({
        data: {
          type: 'person',
          id: '1',
  ...
  module('hasChangedAttrs - includes fragment changes', function () {
    test('hasChangedAttrs returns true when fragment is dirty', function (this: TestContext, assert: Assert) {
      store.push({
        data: {
          type: 'person',
          id: '1',
    ...
    test('hasChangedAttrs returns true when nested fragment in array is dirty', function (this: TestContext, assert: Assert) {
      store.push({
        data: {
          type: 'person',
          id: '1',
  ...
  module('didCommit - updates fragment canonical state', function () {
    test('didCommit updates fragment canonical state from server response', async function (this: TestContext, assert: Assert) {
      store.push({
        data: {
          type: 'person',
          id: '1',
    ...
    test('didCommit clears dirty state without server response data', async function (this: TestContext, assert: Assert) {
      store.push({
        data: {
          type: 'person',
          id: '1',
  ...
  module('rollbackAttrs - cascades to fragments', function () {
    test('rollbackAttrs on owner cascades to fragment', function (this: TestContext, assert: Assert) {
      store.push({
        data: {
          type: 'person',
          id: '1',
    ...
    test('rollbackAttrs cascades to nested fragments in arrays', function (this: TestContext, assert: Assert) {
      store.push({
        data: {
          type: 'person',
          id: '1',
    ...
    test('rollbackAttrs restores removed fragment array items', function (this: TestContext, assert: Assert) {
      store.push({
        data: {
          type: 'person',
          id: '1',
...
module('unit - Fragment Owner Tracking', function (hooks) {
  ...
  test('fragment owner is set when fragment is assigned to record', function (this: TestContext, assert: Assert) {
    store.push({
      data: {
        type: 'person',
        id: '1',
  ...
  test('fragment cannot be reassigned to a different owner', function (this: TestContext, assert: Assert) {
    store.push({
      data: {
        type: 'person',
        id: '1',
  ...
  test('createFragment creates fragment without owner', function (this: TestContext, assert: Assert) {
  ...
  test('assigning createFragment result sets owner', function (this: TestContext, assert: Assert) {
    const name = store.createFragment('name', {
      first: 'Tyrion',
      last: 'Lannister',
    });
  ...
  test('fragment owner is accessible via fragmentOwner property', function (this: TestContext, assert: Assert) {
    store.push({
      data: {
        type: 'person',
        id: '1',
  ...
  test('createRecord accepts an existing fragment instance for a single fragment attr', function (this: TestContext, assert: Assert) {
    const name = store.createFragment('name', {
      first: 'Arya',
      last: 'Stark',
    });
    ...
    try {
      ...
      assert.notOk(
        true,
        `createRecord with fragment instance threw: ${(e as Error).message}`,
      );
      return;
    }
  ...
  test('createRecord accepts existing fragment instances for a fragment-array attr', function (this: TestContext, assert: Assert) {
    ...
    try {
      ...
      assert.notOk(
        true,
        `createRecord with fragment-array instances threw: ${(e as Error).message}`,
      );
      return;
    }
  ...
  test('createRecord still accepts plain object literals for fragment attrs (no regression)', function (this: TestContext, assert: Assert) {
  ...
  test('createRecord asserts when given a fragment instance of the wrong type', function (this: TestContext, assert: Assert) {
...
module('unit - Fragment Edge Cases', function (hooks) {
  ...
  test('accessing fragment default value does not cause infinite recursion', function (this: TestContext, assert: Assert) {
  ...
  test('concurrent fragment access during record instantiation does not cause recursion', function (this: TestContext, assert: Assert) {
  ...
  test('pushing data to record with dirty fragment merges correctly', function (this: TestContext, assert: Assert) {
    store.push({
      data: {
        type: 'person',
        id: '1',
  ...
  test('fragment array maintains order after save', async function (this: TestContext, assert: Assert) {
    store.push({
      data: {
        type: 'person',
        id: '1',
  ...
  test('new record with fragments can be saved', async function (this: TestContext, assert: Assert) {
    const person = store.createRecord('person', {
      name: {
        first: 'Gendry',
        last: 'Baratheon',
  ...
  test('commitWasRejected restores fragment to pre-save state', async function (this: TestContext, assert: Assert) {
    store.push({
      data: {
        type: 'person',
        id: '1',
  ...
  test('deeply nested fragments propagate dirty state correctly', function (this: TestContext, assert: Assert) {
    store.push({
      data: {
        type: 'user',
        id: '1',
