...
module(
  ...
  function (hooks) {
    ...
    test('fragment models do not resolve to a JSON:API application serializer', function (this: TestContext, assert: Assert) {
      const store: TestStore = this.owner.lookup('service:store');
    ...
    test('fragments deserialize via pushPayload when application serializer is FragmentJSONAPISerializer', function (this: TestContext, assert: Assert) {
      const store: TestStore = this.owner.lookup('service:store');
    ...
    test('a per-fragment-type serializer is honored end-to-end during pushPayload', function (this: TestContext, assert: Assert) {
    ...
    test('a serializer:-fragment registration is honored end-to-end during pushPayload', function (this: TestContext, assert: Assert) {
    ...
    test('record.serialize() outbound with a JSON:API application serializer', function (this: TestContext, assert: Assert) {
