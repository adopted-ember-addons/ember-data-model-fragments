...
module('unit - `MF.fragmentArray`', function (hooks) {
  ...
  test('fragment arrays can be copied', async function (this: TestContext, assert: Assert) {
    const data = {
      names: [
        {
          first: 'Meryn',
  ...
  test('fragment arrays have an owner', async function (this: TestContext, assert: Assert) {
    store.push({
      data: {
        type: 'person',
        id: 1,
  ...
  test('fragments can be created and added through the fragment array', async function (this: TestContext, assert: Assert) {
    store.push({
      data: {
        type: 'person',
        id: 1,
  ...
  test('fragments can be added to the fragment array', async function (this: TestContext, assert: Assert) {
    store.push({
      data: {
        type: 'person',
        id: 1,
  ...
  test('objects can be added to the fragment array', async function (this: TestContext, assert: Assert) {
    store.push({
      data: {
        type: 'person',
        id: 1,
  ...
  test('fragments can be removed from the fragment array', async function (this: TestContext, assert: Assert) {
    store.push({
      data: {
        type: 'person',
        id: 1,
  ...
  test('changes to array contents change the fragment array `hasDirtyAttributes` property', async function (this: TestContext, assert: Assert) {
    store.push({
      data: {
        type: 'person',
        id: 1,
  ...
  test('changes to array contents and fragments can be rolled back', async function (this: TestContext, assert: Assert) {
    store.push({
      data: {
        type: 'person',
        id: 1,
  ...
  test('can be updated to null', function (this: TestContext, assert: Assert) {
    ...
    assert.deepEqual(
      person.names.toArray().map((f: any) => f.serialize()),
      [
        {
          first: 'Catelyn',
          last: 'Tully',
