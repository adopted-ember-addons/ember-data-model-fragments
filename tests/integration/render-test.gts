...
module('Integration | Rendering', function (hooks) {
  ...
  test('construct fragments without autotracking.mutation-after-consumption error', async function (this: TestContext, assert: Assert) {
    ...
    // A class declaration rather than an expression: decorators are not
    // allowed in class expressions.
    class State {
      @tracked show = false;
    }
  ...
  test('fragment array computed property', async function (this: TestContext, assert: Assert) {
    class OrderListComponent extends Component<{ Args: { order: any } }> {
      get productsByPrice() {
  ...
  test('fragment array data pushed', async function (this: TestContext, assert: Assert) {
  ...
  test('fragment is destroyed', async function (this: TestContext, assert: Assert) {
  ...
  test('fragment array is destroyed', async function (this: TestContext, assert: Assert) {
    const order = store.createRecord('order', { id: 1 });
  ...
  test('array destroyed', async function (this: TestContext, assert: Assert) {
