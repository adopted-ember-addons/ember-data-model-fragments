...
export default class FragmentCache {
  ...
  declare __innerCache: any;
  declare __fragmentState: any;
  declare __recordDataProxies: Map<string, FragmentRecordDataProxy>;
  declare __storeValidated: boolean;
  ...
  getFragmentOwner(
    identifier: FragmentIdentifier,
  ): FragmentOwnerInfo | null | undefined {
  ...
  upsert(
    identifier: FragmentIdentifier,
    data: any,
    hasRecordOrCalculateChanges?: boolean,
  ): any {
  ...
  didCommit(identifier: FragmentIdentifier, data: any): any {
    ...
    let fragmentData: { attributes: Record<string, any> } | null = null;
    if (attributes) {
      const definitions = this.__storeWrapper
        .getSchemaDefinitionService()
        .attributesDefinitionFor(identifier);
