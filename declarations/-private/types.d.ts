...
export type RegisteredFragment<K> = K extends keyof FragmentRegistry ? FragmentRegistry[K] : Fragment;
/**
...
type FragmentDataKeys<T> = {
    [K in Exclude<keyof T, keyof Fragment>]-?: T[K] extends (...args: never[]) => unknown ? never : K;
 ...
 */
type RawFragmentValue<V> = V extends FragmentArray<infer F> ? (FragmentDataFor<F> | F)[] : V extends StatefulArray<infer E> ? E[] : V extends FragmentLike ? FragmentDataFor<V> | V : V;
 ...
 */
export type FragmentData<K> = K extends keyof FragmentRegistry ? FragmentDataFor<FragmentRegistry[K]> : Record<string, unknown>;
/**
 ...
 */
export type FragmentAttributeDecorator = (target: object, key: string, desc?: PropertyDescriptor) => void;
/**
 ...
 */
export type DefaultValueFn<Options, Value> = (record: Model, options: Options, key: string) => Value;
...
export interface FragmentOptions<K extends FragmentType = FragmentType> {
    ...
    defaultValue?: FragmentData<K> | FragmentData<K>[] | DefaultValueFn<FragmentOptions<K>, FragmentData<K> | FragmentData<K>[] | RegisteredFragment<K> | RegisteredFragment<K>[] | null> | null;
}
/**
...
export interface ArrayOptions {
    defaultValue?: unknown[] | DefaultValueFn<ArrayOptions, unknown[] | null> | null;
}
/**
