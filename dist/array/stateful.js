...
const definition = {
  ...
  replace(start, deleteCount, items) {
    ...
    assert('Attempted to update the fragment array after it was destroyed', !this.isDestroyed && !this.isDestroying);
...
const StatefulArray = EmberObject.extend(MutableArray, definition);

export { StatefulArray as default };
