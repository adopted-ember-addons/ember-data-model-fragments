...
class FragmentRecordDataProxy {
  ...
  _newFragmentRecordDataForKey(key, attributes) {
    const fragmentIdentifier = this.__cache.newFragmentIdentifierForKey(this.identifier, key, attributes);
  ...
  _newFragmentRecordData(definition, attributes) {
    ...
    const fragmentIdentifier = this.__cache.__fragmentState._newFragmentIdentifier(this.identifier, definition, attributes);
    return this.__cache.createFragmentRecordData(fragmentIdentifier);
  }
  get _fragmentArrayCache() {
    return this.__cache.__fragmentState._getFragmentArrayCacheMap(this.identifier);
  }
  ...
  getCanonicalState() {
    ...
    const fragmentState = this.__cache.getFragmentCanonicalState(this.identifier);
  ...
  getCurrentState() {
    ...
    const definitions = this.__cache.__storeWrapper.getSchemaDefinitionService().attributesDefinitionFor(this.identifier);
  ...
  notifyStateChange(key) {
    this.__cache.__storeWrapper.notifyChange(this.identifier, 'attributes', key);
  }
  fragmentDidDirty() {
...
export { FragmentRecordDataProxy as default };
//# sourceMappingURL=fragment-record-data-proxy.js.map
