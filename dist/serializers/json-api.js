...
import { fragmentSerialize, fragmentTransformFor, fragmentApplyTransforms, fragmentExtractAttributesJSONAPI } from './utils.js';
...
/**
  ...
  @public
*/
class FragmentJSONAPISerializer extends JSONAPISerializer {
  serialize(snapshot, options) {
    return fragmentSerialize(this, snapshot, super.serialize(snapshot, options));
  }
  ...
  */
  transformFor(attributeType) {
    return fragmentTransformFor(this, attributeType, JSONAPISerializer.prototype.transformFor);
  }
  ...
  */
  extractAttributes(modelClass, resourceHash) {
    return fragmentExtractAttributesJSONAPI(this, modelClass, resourceHash, JSONAPISerializer.prototype.extractAttributes);
  }
}

export { FragmentJSONAPISerializer as default };
