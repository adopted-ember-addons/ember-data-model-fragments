...
import { fragmentSerialize, fragmentTransformFor, fragmentApplyTransforms, fragmentExtractAttributes } from './utils.js';
...
class FragmentRESTSerializer extends RESTSerializer {
  ...
  */
  transformFor(attributeType) {
    return fragmentTransformFor(this, attributeType, RESTSerializer.prototype.transformFor);
  }
  ...
  */
  extractAttributes(modelClass, resourceHash) {
    return fragmentExtractAttributes(this, modelClass, resourceHash, RESTSerializer.prototype.extractAttributes);
  }
}

export { FragmentRESTSerializer as default };
