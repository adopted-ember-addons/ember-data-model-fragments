const CACHE_METHODS = ['createFragmentRecordData', 'getFragment', 'hasFragment', 'setDirtyFragment', 'isFragmentDirty', 'getFragmentOwner', 'setFragmentOwner', 'newFragmentIdentifierForKey', 'getFragmentArrayCache', 'setFragmentArrayCache', 'rollbackFragment', 'hasChangedFragments', 'changedFragments', 'getFragmentCanonicalState', 'getFragmentCurrentState'];
...
function fragmentCacheFor(store) {
  return installCacheManagerCompat(store);
}

export { fragmentCacheFor as default, installCacheManagerCompat };
