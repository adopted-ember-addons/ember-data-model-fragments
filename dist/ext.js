export { default as Model } from '@ember-data/model';
...
/**
  ...
  @private
*/
const oldSnapshotAttributes = Object.getOwnPropertyDescriptor(Snapshot.prototype, '_attributes');
    ...
    if (macroCondition(dependencySatisfies('ember-data', '>=5.8.0'))) {
      ...
      if (schema) {
        ...
        Object.entries(definitions).forEach(([key, definition]) => {
          ...
          attrs[key] = convertSnapshotValue(fragmentCacheFor(this._store).getAttr(this.identifier, key));
        });
      }
    }
